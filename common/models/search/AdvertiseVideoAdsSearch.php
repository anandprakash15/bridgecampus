...
/**
 * AdvertiseVideoAdsSearch represents the model behind the search form of `common\models\AdvertiseVideoAds`.
 */
class AdvertiseVideoAdsSearch extends AdvertiseVideoAds
{
    /**
     * {@inheritdoc}
     */
