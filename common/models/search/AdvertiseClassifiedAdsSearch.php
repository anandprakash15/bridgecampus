...
/**
 * AdvertiseClassifiedAdsSearch represents the model behind the search form of `common\models\AdvertiseClassifiedAds`.
 */
class AdvertiseClassifiedAdsSearch extends AdvertiseClassifiedAds
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'bannerType', 'country', 'state', 'city', 'status', 'created_by', 'updated_by'], 'integer'],
    ...
    {
        $query = AdvertiseClassifiedAds::find();
