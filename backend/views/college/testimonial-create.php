...
<div class="testimonial-details-form">
  <div class="custumbox box box-info">
    ...
    <?= $form->field($model, 'status')->dropDownList([ 1 => 'Approved', 2 => 'Pending', 3 => 'Blocked' ], ['options'=>[2=>['Selected'=>true]]], ['prompt' => 'Select Status'])->label('Status') ?>
