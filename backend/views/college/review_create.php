...
if($model->isNewRecord){
  ...
  $this->title = $college->name.' Review';
  ...
  $this->title = $college->name.' Update Review';
...
<div class="university-review-form">
    ...
    <?= $form->field($model, 'review_status')->dropDownList([ 1 => 'Approved', 2 => 'Pending', 3 => 'Blocked' ],
     ['options'=>[2=>['Selected'=>true]]], ['prompt' => 'Select Status'])->label('Status') ?>
