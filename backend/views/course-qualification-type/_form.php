...
<div class="course-qualification-type-form">
<div class="custumbox box box-info">
   ...
   <?= $form->field($model, 'statue')->dropDownList(Yii::$app->myhelper->getActiveInactive(),['class'=>'form-control'])?>
...
<?php $this->registerJs("".Yii::$app->myhelper->formsubmitedbyajax('w0','../course-duration/index')."");?>