      ...
      <section class="sidebar">
        <?php echo Menu::widget([
          ...
          'items' => [
            ...
            ['label' => '<i class="fa fa-book" aria-hidden="true"></i> <span>Courses</span>', 'url' => ['/site/courses']],
            ['label' => '<i class="fa fa-university" aria-hidden="true"></i> <span>University</span>', 'url' => ['/site/university']],
