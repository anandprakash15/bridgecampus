        ...
        <div class="col-md-3">
         <div class="box box-solid">
          ...
          <div class="box-body no-padding">
            <?php 
              $advertiseData= \common\models\AdvertiseVideoBanner::find()->where(['status' => '1'])->orderBy([ 'name' => SORT_ASC])->all();
              $advertiseList=ArrayHelper::map($advertiseData,'id','name');

              $menuItems = [];
              foreach ($advertiseList as $key => $value) {
                        $url = Url::to(['advertise-video-ads/index','id'=>@Yii::$app->params['uID'],'rid'=>$key]);
