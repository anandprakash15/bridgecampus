        ...
        <div class="col-md-3">
         <div class="box box-solid">
          <div class="box-header with-border">
            ...
            <h3 class="box-title"> <?= 'Advertise Video Ads' ?></h3>
          </div>
          <div class="box-body no-padding">
            <?php 
              $advertiseData= \common\models\ClassifiedAdLocations::find()->where(['status' => '1'])->orderBy([ 'name' => SORT_ASC])->all();
              $advertiseList=ArrayHelper::map($advertiseData,'id','name');

              $menuItems = [];
              foreach ($advertiseList as $key => $value) {
                        $url = Url::to(['advertise-classified-ads/index','id'=>@Yii::$app->params['uID'],'rid'=>$key]);
