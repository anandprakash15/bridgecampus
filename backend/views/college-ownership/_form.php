...
<div class="college-ownership-form">
    ...
    <?= $form->field($model, 'ownership_name')->textInput(['maxlength' => true]) ?>
...
<?php $this->registerJs("".Yii::$app->myhelper->formsubmitedbyajax('w0','../college-ownership/index')."");?>